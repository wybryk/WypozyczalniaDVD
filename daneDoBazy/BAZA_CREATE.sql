...
CONSTRAINT EG_FI_FK FOREIGN KEY (ID_FILMU) REFERENCES FILMY(ID_FILMU)
);
...
CZY_ADMIN CHAR NOT NULL CONSTRAINT ADM_CHECK CHECK((CZY_ADMIN LIKE 'T') OR (CZY_ADMIN LIKE 'F')),
